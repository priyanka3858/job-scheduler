...
if __name__ == '__main__':
    ...
    while True:
        ...
        user_inp = input("Please enter command for your daily routine: Example ===> add, remove, change: ")
        ...
        try:
            ...
            if  user_inp == "add":
                ...
                scheduler_list = my_scheduler._MyScheduler__add_to_myscheduler(user_inp, time, scheduler_list)

                print(Colors.FontColor.blue, "Your schedule has been added to the list",
                      Colors.reset)
            ...
            if user_inp == "remove":
                ...
                scheduler_list = my_scheduler._MyScheduler__remove_from_myscheduler(user_inp, scheduler_list)
            ...
            if user_inp == "change":
                index = input("enter the number of scheduler that you want to change: ")
                user_inp_value = input("enter name activity name to set:")
                time = schedule_logger.format_time()

                scheduler_list = my_scheduler._MyScheduler__change_myscheduler(index, user_inp_value, time, scheduler_list)
